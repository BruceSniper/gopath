...
func main() {
	...
	//      http://localhost:8000?date=20190310&city=beijing
	//GET： http://localhost:8000/weather/2019-03-10/beijing
	//      http://localhost:8000/weather/2019-03-11/beijing
	//      http://localhost:8000/weather/2019-03-11/tianjin
	...
	app.Get("/wether/{date}/{city}", func(context context.Context) {
		path := context.Path()
