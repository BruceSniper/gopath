...
func NewMysqlEngine() *xorm.Engine {
	...
	//err = engine.CreateTables(new(model.Permission))
	//err = engine.CreateTables(new(model.City))
	//err = engine.CreateTables(new(model.Admin))
	//err = engine.CreateTables(new(model.AdminPermission))
	//err = engine.CreateTables(new(model.User))
	//err = engine.CreateTables(new(model.UserOrder))
