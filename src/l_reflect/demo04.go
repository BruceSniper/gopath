...
func main() {
	...
	fmt.Println(newValue.Interface())           //1.23
	...
	//value.SetFloat(6.28) //panic: reflect: reflect.flag.mustBeAssignable using unaddressable value
